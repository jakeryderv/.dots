...
| `install-pi.sh` | [Pi coding agent](https://pi.dev) | Latest global npm release, installed with lifecycle scripts disabled. Pi packages are restored separately from tracked [`pi`](../docs/pi.md) settings. |
